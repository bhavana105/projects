...
<div className=" sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={{width:"280px"}}>
    ...
    <ul className="nav nav-pills flex-column mb-auto">
      <li className="nav-item" >
        <a href="#" className={`nav-link text-white ${activebtn === "Home" &&"active"} `} aria-current="page" onClick={()=>{handleActiveBtn("Home")}}>
          <svg className="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlinkHref="#home"></use></svg>
          Home
        </a>
      </li>
      <li>
        <a href="#"className={`nav-link text-white ${activebtn === "Create post" &&"active"} `} onClick={()=>{handleActiveBtn("Create post")}}>
